  ...
  <main class="app">
    ...
    <div class="row">
      ...
      <div style="display: flex; flex-direction: row;">
        <div style="flex:5">
          <h1 style="padding: 25px; padding-bottom: 0px;">Constructing the Reservation Class</h1>
        <p style="padding: 25px; padding-top: 0px">To understand the concept of composition, create the appropriate constructors.</p>

        </div>
        <!--help buttons-->
        <div style="flex:1">
          <button style="float: right; margin-bottom: 30px;" :style="{ display: display[0] }" @click="popup('constructorWritingComponent')" class="button-30">Help</button>
