...
<template>
  <main class="app">
    ...
    <div class="column" style="position:sticky; top: 20%; left: 60%; float: right">
      <div class="column">
        <div class="codebox">
          <h5>Aggregation: </h5>
    ...
    <div class="row">
      ...
      <div class="column">
        ...
        <div style="flex:5">
          <h1 style="padding: 25px; padding-bottom: 0px;">Constructing the TestDriver Class</h1>
        <p style="padding: 25px; padding-top: 0px">Complete the reservation of a vehicle to a customer by creating the corresponding objects and calling the necessary methods.</p>

        </div>
        <!--help buttons-->
        <div style="flex:1">
          <button style="float: right; margin-bottom: 30px;" :style="{ display: display[0] }" @click="popup('arraysComponent')" class="button-30">Help</button>
          <button style="float: right; margin-bottom: 30px;" :style="{ display: display[1] }" @click="popup('objectCreationComponent')" class="button-30">Help</button>
          <button style="float: right; margin-bottom: 30px;" :style="{ display: display[2] }" @click="popup('setterComponent')" class="button-30">Help</button>
          <button style="float: right; margin-bottom: 30px;" :style="{ display: display[3] }" @click="popup('objectCreationComponent')" class="button-30">Help</button>
          <button style="float: right; margin-bottom: 30px;" :style="{ display: display[4] }" @click="popup('objectCreationComponent')" class="button-30">Help</button>
...
public class TestDriver {
    ...
    public static void main(String[] args) {</pre>&emsp;
          ...
          <input spellcheck="false" id="two" maxlength="11" style="width: 105px;" v-model="two">{ <p id="comment">
            //Create an array of Customer objects with 3 array-objects</p><br>
            <!-- arraysComponent -->
...
public class TestDriver {
	...
	public static void main(String[] args) {
		...
		Reservation robj= new Reservation(cobj[0],vobj);
          ...
          <p id="comment">//Clue: To obtain the vehicle object, use the appropriate Vehicle class function (getVehicleObjc) </p><br>
          c
          <!-- setterComponent -->
