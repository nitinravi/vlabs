    ...
    <div class="flex-row">
        <div style="width: 50%;">
            ...
            <div class="outbox">            
                    ...
                    <span id="comment">//Class declaration</span>
                    <pre>
                    public class Demo {
                        int demoVariable;
            ...
            <div class="content">
                <p>You can declare a class by writing the name of the 
                    next to the class keyword, followed by the flower 
                    braces. Within these, you need to define the body 
                    (contents) of the class i.e. fields and methods. 
                    To make the class accessible to all (classes) you
