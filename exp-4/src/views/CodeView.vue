...
<script>
//import all the components from the components/help folder
...
import classCreationComponent from "../components/help/classCreationComponent.vue";
...
<template>
  <main class="app">
    ...
    <div class="row">
      <div class="column">
        <h1 style="padding: 25px; padding-bottom: 0px;">Step 2: Fill in the Java code for the following updated Customer
          class.
        </h1>
      ...
      <div class="column">
        ...
        <div id="myModal">
          ...
          <div style="flex: 5">
            <h1 style="padding: 25px; padding-left: 0px;">Constructing the Customer Class</h1>
        <p style="padding-bottom: 25px">Create the required variables and functions to store details of the Customer</p>
        </div>
        <!--help buttons-->
        <div style="display: flex; flex: 1; align-items: center; justify-content: center;">
          <button style="float: right; margin-bottom: 30px;" :style="{ display: display[0] }" @click="popup('classCreationComponent')" class="button-30">Help</button>
          ...
          <button style="float: right; margin-bottom: 30px;" :style="{ display: display[3] }" @click="popup('newVariableComponent')" class="button-30">Help</button>
          <button style="float: right; margin-bottom: 30px;" :style="{ display: display[4] }" @click="popup('newVariableComponent')" class="button-30">Help</button>
          <button style="float: right; margin-bottom: 30px;" :style="{ display: display[5] }" @click="popup('newVariableComponent')" class="button-30">Help</button>
          <button style="float: right; margin-bottom: 30px;" :style="{ display: display[6]}" @click="popup('newVariableComponent')" class="button-30">Help</button>
          ...
          <button style="float: right; margin-bottom: 30px;" :style="{ display: display[8]}" @click="popup('constructorWritingComponent')" class="button-30">Help</button>
          <button style="float: right; margin-bottom: 30px;" :style="{ display: display[9]}" @click="popup('constructorWritingComponent')" class="button-30">Help</button>
          <button style="float: right; margin-bottom: 30px;" :style="{ display: display[10]}" @click="popup('getterComponent')" class="button-30">Help</button>
          <button style="float: right; margin-bottom: 30px;" :style="{ display: display[11]}" @click="popup('setterComponent')" class="button-30">Help</button>
        </div>
        </div>
